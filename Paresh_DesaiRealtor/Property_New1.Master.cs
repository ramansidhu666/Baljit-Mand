    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesFaceBookShare()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fbProprtyUrl.Content = string.Format("http://mandbaljit.ca//PropertyDetails.aspx?MLSID={0}&PropertyType={1}", dt.Rows[0]["MLS"].ToString(), dt.Rows[0]["pType"].ToString());
                //fbProprtySiteName.Content = "";
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li style='background:none;'><a href='Featured_properties.aspx' title='Featured Listings'>Featured Listings</a></li>");
